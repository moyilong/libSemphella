...
string CAPI ZEN_LIB::md5_string(const unsigned char result[ZEN_SHA1_HASH_SIZE])
{
	return common_convert(result, ZEN_MD5_HASH_SIZE);
}
string CAPI ZEN_LIB::sha1_string(const unsigned char result[ZEN_SHA1_HASH_SIZE])
{
	return common_convert(result, ZEN_SHA1_BLOCK_SIZE);
}